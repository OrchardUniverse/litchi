...
def optimize_code(file, query_or_file, inplace, dry_run):
    ...
    if inplace:
        ...
        logging.info(f"Optimized code and saved into {temp_file_name}")
        ...
        if response in ['yes', 'y']:
            ...
            logging.info(f"Do not overwrite source file and you can find optimized code in {temp_file_name}.")
